    ...
    return (
        <div className="dashboard-content-container">
            <Breadcrumb style={{ marginBottom: "16px" }}>
                ...
                <Breadcrumb.Item>{data && data.exhibit.Name}</Breadcrumb.Item>
            </Breadcrumb>
            {data &&
                <Fragment>
                    ...
                    <Form layout="vertical">
                        <Form.Item name="name" label="Exhibit Name" rules={[{ required: true, message: 'Please enter exhibit\'s name' }]} className="form-group" validateTrigger="onBlur" initialValue={data.exhibit.Name}>
                            <Input />
                        </Form.Item>
                    ...
                    <Form layout="vertical" >
                        <Form.Item label="Status" className="form-group">
                            <p className="text-small text-grey">
                                ...
                                have read access to this exhibit. The default status is "Paused" during exhibit creation. To enable public read access,
                    ...
                    <Form layout="vertical">
                        <Form.Item className="form-group">
                            ...
                            <Form.Item name="languages" style={{ marginBottom: 0 }}>
                                <LanguageSelect defaultValues={data.exhibit.defaultValues} />
                            </Form.Item>
                        </Form.Item>
                    ...
                    <Form layout="vertical" onFinish={(value) => {
                        //On select, go to the translated page
